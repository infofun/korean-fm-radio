...
async function generateM3U() {
    ...
    if (kbs2fm) m3u += `#EXTINF:-1 group-title="지상파", KBS 2FM (쿨FM) [89.1]\n${kbs2fm}\n\n`;
    if (mbcFm4u) m3u += `#EXTINF:-1 group-title="지상파", MBC FM4U [91.9]\n${mbcFm4u}\n\n`;
    if (kbs1fm) m3u += `#EXTINF:-1 group-title="지상파", KBS 1FM (클래식FM) [93.1]\n${kbs1fm}\n\n`;
    
    m3u += `#EXTINF:-1 group-title="뉴스/교양", YTN 라디오 [94.5]\nhttps://radiolive.ytn.co.kr/radio/_definst_/20211118_fmlive/playlist.m3u8\n\n`;
    m3u += `#EXTINF:-1 group-title="뉴스/교양", TBS FM [95.1]\nhttps://cdnfm.tbs.seoul.kr/tbs/_definst_/tbs_fm_web_360.smil/playlist.m3u8\n\n`;
    
    if (mbcSfm) m3u += `#EXTINF:-1 group-title="지상파", MBC 표준FM [95.9]\n${mbcSfm}\n\n`;
    
    m3u += `#EXTINF:-1 group-title="공공", 국방FM [96.7]\nhttps://mediaworks.dema.mil.kr/live_edge/audio.sdp/playlist.m3u8\n\n`;
    
    if (kbs1) m3u += `#EXTINF:-1 group-title="지상파", KBS 1라디오 [97.3]\n${kbs1}\n\n`;
    
    m3u += `#EXTINF:-1 group-title="음악", 국악방송 [99.1]\nhttps://mgugaklive.nowcdn.co.kr/gugakradio/gugakradio.stream/playlist.m3u8\n\n`;
    m3u += `#EXTINF:-1 group-title="뉴스/교양", OBS 라디오 [99.9]\nhttps://vod3.obs.co.kr:444/live/obsstream1/radio.stream/playlist.m3u8\n\n`;
    m3u += `#EXTINF:-1 group-title="뉴스/교양", TBN 경인교통방송 [100.5]\nhttp://radio2.tbn.or.kr:1935/gyeongin/myStream/playlist.m3u8\n\n`;
    m3u += `#EXTINF:-1 group-title="뉴스/교양", TBS eFM (영어방송) [101.3]\nhttps://cdnfm.tbs.seoul.kr/tbs/_definst_/tbs_efm_web_360.smil/playlist.m3u8\n\n`;
    
    if (sbsLove) m3u += `#EXTINF:-1 group-title="지상파", SBS 러브FM [103.5]\n${sbsLove}\n\n`;
    
    m3u += `#EXTINF:-1 group-title="교육", EBS FM [104.5]\nhttps://ebsonair.ebs.co.kr/fmradiofamilypc/familypc1m/playlist.m3u8\n\n`;
    
    if (kbs3) m3u += `#EXTINF:-1 group-title="지상파", KBS 3라디오 [104.9]\n${kbs3}\n\n`;
